...
public class ToolBar extends FrameLayout {
    ...
    public ToolBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (mStyleType == 0 ){
            ...
            View.inflate(context, R.layout.layout_toolbar_light, this);
        }
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mTitleTextColor = a.getColor(R.styleable.ToolBar_titleTextColor, getResources().getColor(mStyleType==0?R.color.colorWhite:R.color.colorBlackLight));
        mTitleTextSize = a.getDimensionPixelSize(R.styleable.ToolBar_titleTextSize, sp2px(18));
    ...
    public void setTitle(int resId){
        mTitle = getResources().getText(resId);
        mTvTitle.setText(mTitle);
    }
