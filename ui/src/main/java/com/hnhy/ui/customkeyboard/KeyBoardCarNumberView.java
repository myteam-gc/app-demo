...
public class KeyBoardCarNumberView extends LinearLayout {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            switch (primaryCode) {
                ...
                default:
                    switch (mInputType) {
                        case 0:
                            if (mOnChineseInputListener != null) {
                                mOnChineseInputListener.onChineseInput();
                            }
    ...
    public void setOnChineseInputListener(OnChineseInputListener mOnChineseInputListener) {
        this.mOnChineseInputListener = mOnChineseInputListener;
    }
